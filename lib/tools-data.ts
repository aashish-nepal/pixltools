...
export const TOOLS: ToolData[] = [
    {
        ...
        icon: "🗜️",
        metaTitle: "Compress Image Free – Up to 90% Smaller, Instant Download",
        metaDesc: "Reduce JPG, PNG & WebP file sizes up to 90% in seconds. Zero quality loss, no signup, no watermarks. The fastest free image compressor online.",
    ...
    },
    {
        ...
        icon: "📐",
        metaTitle: "Resize Image Free – Exact Pixels, %, or Social Media Presets",
        metaDesc: "Resize any photo to exact pixel dimensions or scale by percentage — free, no signup. Supports Instagram, YouTube, Twitter presets. Download in seconds.",
        acceptedFormats: ["image/jpeg", "image/png", "image/webp"],
        isPopular: true,
    ...
    },
    {
        ...
        icon: "✂️",
        metaTitle: "Crop Image Free – Any Size, Aspect Ratio or Custom Area",
        metaDesc: "Crop photos online in seconds — choose 1:1, 16:9, 4:5 or enter exact pixels. Free, no signup, instant download. Perfect for Instagram, YouTube & print.",
        acceptedFormats: ["image/jpeg", "image/png", "image/webp"],
    ...
    },
    {
        ...
        icon: "🔏",
        metaTitle: "Add Watermark to Image Free – Custom Text, Opacity & Position",
        metaDesc: "Protect your photos with custom text watermarks — choose any position, size & opacity. 100% free, no signup, no branding added. Results in seconds.",
        acceptedFormats: ["image/jpeg", "image/png", "image/webp"],
    ...
    },
    {
        ...
        icon: "🔍",
        metaTitle: "EXIF Metadata Viewer Free – Camera, GPS & Date Instantly",
        metaDesc: "See hidden data in any photo — camera model, GPS location, shutter speed, ISO & more. Free EXIF viewer, no signup, instant results.",
    ...
    },
    {
        ...
        icon: "🪄",
        metaTitle: "Remove Image Background Free – AI Cutout, Transparent PNG",
        metaDesc: "Erase any background instantly with AI — get a clean transparent PNG in one click. 100% free, no signup, no watermarks. Perfect for products & portraits.",
        acceptedFormats: ["image/jpeg", "image/png", "image/webp"],
        outputFormat: "png",
        isPopular: true,
    ...
    },
    {
        ...
        icon: "🔭",
        metaTitle: "AI Image Upscaler Free – Sharper at 2x, 3x or 4x Online",
        metaDesc: "Upscale photos 2x, 3x or 4x without blurring — AI adds real detail, not just stretched pixels. Free, no account, instant download.",
        acceptedFormats: ["image/jpeg", "image/png", "image/webp"],
    ...
    },
    {
        ...
        icon: "💎",
        metaTitle: "Sharpen Image Online Free – Fix Blurry Photos in One Click",
        metaDesc: "Make soft or slightly blurry photos crisp and defined — free, no signup. Professional unsharp mask sharpening with no halo artifacts. Instant download.",
        acceptedFormats: ["image/jpeg", "image/png", "image/webp"],
    ...
    },
    {
        ...
        icon: "🖼️",
        metaTitle: "Add Border to Image Free – Custom Color, Width & Style",
        metaDesc: "Frame any photo with a custom border — choose exact pixel width and any color. Free, no signup, instant download. Great for Instagram & print.",
        acceptedFormats: ["image/jpeg", "image/png", "image/webp"],
    ...
    },
    {
        ...
        icon: "🎨",
        metaTitle: "SVG to PNG Converter Free – Any Resolution, Instant Download",
        metaDesc: "Convert SVG vector files to high-quality PNG at any resolution — free, no signup, no watermarks. Perfect for icons, logos & web assets.",
    ...
    },
    {
        ...
        icon: "📱",
        metaTitle: "HEIC to JPG Free – Convert iPhone Photos Online (No App)",
        metaDesc: "Convert iPhone HEIC photos to JPG instantly in any browser — no app, no account needed. Free, no watermarks. Works on iPhone, Mac & Windows.",
    ...
    },
    {
        ...
        icon: "🖼️",
        metaTitle: "Free Photo Collage Maker – Combine Up to 16 Photos Online",
        metaDesc: "Create beautiful photo collages online — combine up to 16 images in custom grid layouts. No signup, no watermarks, download as JPG or PNG instantly.",
        acceptedFormats: ["image/jpeg", "image/png", "image/webp"],
        isNew: true,
